...
export const sidebarSectionDividerTestkitFactory = enzymeUniTestkitFactoryCreator(load(require('../src/SidebarSectionDivider/SidebarSectionDivider.uni.driver')));

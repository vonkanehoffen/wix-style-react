...
import { dropdownTestkitFactory as DropdownEnzymeTestkitFactory } from '../../testkit/enzyme';
import { mount } from 'enzyme';

function testkits() {
  const vanilla = dropdownTestkitFactory({
    dataHook: 'hi',
  ...
  const enzyme = DropdownEnzymeTestkitFactory({
    dataHook: 'shbem',
    wrapper: mount(<div />),
  });
}
